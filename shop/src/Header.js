...
import ClothingCategoryLayout from "./ClothingCategoryLayout";
            ...
            <ul className="Navigation">
              <li className="Tab">
                ...
                >
                  {" "}
                  CLOTHING
                  {isShown && <ClothingCategoryLayout />}
                </a>
              </li>
              <li className="Tab">
                <a
                  ...
                  onMouseLeave={() => setIsShown(false)}
                >
                  SHOES {isShown && <ShoesCategoryLayout />}
                </a>
              </li>
              <li className="Tab">
                <a
                  ...
                  onMouseLeave={() => setIsShown(false)}
                >
                  ACCESSORIZE {isShown && <AccessorizeCategoryLayout />}
                </a>
              </li>
              <li className="Tab">
                <a
                  ...
                  onMouseLeave={() => setIsShown(false)}
                >
                  BRIDAL {isShown && <BridalCategoryLayout />}
                </a>
              </li>
              <li className="Tab">
